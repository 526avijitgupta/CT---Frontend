...
<div class="btn-group-vertical" id="left-aside-menu" style="float:left;">
	...
	<button type="button" class="btn btn-default" id="flights-hotels" title="Find packages around the world. Book hotels and flights together and save big" onclick="location.href='hotels-flights.php'">
